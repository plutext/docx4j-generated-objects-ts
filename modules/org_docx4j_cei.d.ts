// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_cei]. Do not edit.
...
export interface CTCommentEntityInfo {
  TYPE_NAME?: 'org_docx4j_cei.CTCommentEntityInfo';
  extLst?: Dep_org_docx4j_w16.CTExtensionList;
  entityType?: number;
}

export type CommentEntityInfoElement = TypedNamedValue<CTCommentEntityInfo>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = CommentEntityInfoElement;

/** The Jsonix mapping [org_docx4j_cei] exported by the module's JavaScript file. */
export declare const org_docx4j_cei: JsonixMapping<RootElement>;
