...
export interface CTDrawing {
  ...
  egAnchor?: (CTTwoCellAnchor | CTOneCellAnchor | CTAbsoluteAnchor | Dep_org_docx4j_mce.AlternateContent)[];
}
...
export interface CTGroupShape {
  ...
  spOrGrpSpOrGraphicFrame?: (CTShape | CTGroupShape | CTGraphicalObjectFrame | CTConnector | CTPicture | Dep_org_docx4j_mce.AlternateContent)[];
}
