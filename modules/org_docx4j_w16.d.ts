// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_w16]. Do not edit.
// Describes the objects Jsonix produces when unmarshalling with this module's mappings.
import type * as Dep_org_docx4j_w16cex from './org_docx4j_w16cex';
...
export interface CTExtension {
  TYPE_NAME?: 'org_docx4j_w16.CTExtension';
...
export interface CTExtensionList {
  TYPE_NAME?: 'org_docx4j_w16.CTExtensionList';
  readonly PARENT?: Dep_org_docx4j_w16cex.CTCommentExtensible | Dep_org_docx4j_w16cex.CTCommentsExtensible;
  ext?: CTExtension[];
}

/** The Jsonix mapping [org_docx4j_w16] exported by the module's JavaScript file. */
export declare const org_docx4j_w16: JsonixMapping;
