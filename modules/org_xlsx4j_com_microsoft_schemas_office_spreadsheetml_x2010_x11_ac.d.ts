// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_xlsx4j_com_microsoft_schemas_office_spreadsheetml_x2010_x11_ac]. Do not edit.
...
export interface CTAbsolutePath {
  TYPE_NAME?: 'org_xlsx4j_com_microsoft_schemas_office_spreadsheetml_x2010_x11_ac.CTAbsolutePath';
  url: string;
}

export type AbsPathElement = TypedNamedValue<CTAbsolutePath>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = AbsPathElement;

/** The Jsonix mapping [org_xlsx4j_com_microsoft_schemas_office_spreadsheetml_x2010_x11_ac] exported by the module's JavaScript file. */
export declare const org_xlsx4j_com_microsoft_schemas_office_spreadsheetml_x2010_x11_ac: JsonixMapping<RootElement>;
