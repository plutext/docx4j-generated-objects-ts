// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_w16cex]. Do not edit.
// Describes the objects Jsonix produces when unmarshalling with this module's mappings.
import type * as Dep_org_docx4j_w16 from './org_docx4j_w16';
...
export interface CTCommentExtensible {
  TYPE_NAME?: 'org_docx4j_w16cex.CTCommentExtensible';
  readonly PARENT?: CTCommentsExtensible;
  extLst?: Dep_org_docx4j_w16.CTExtensionList;
  dateUtc?: XmlCalendar;
  durableId: string;
  intelligentPlaceholder?: string;
}

export interface CTCommentsExtensible {
  TYPE_NAME?: 'org_docx4j_w16cex.CTCommentsExtensible';
  commentExtensible?: CTCommentExtensible[];
  extLst?: Dep_org_docx4j_w16.CTExtensionList;
  ignorable?: string;
}

export type CommentsExtensibleElement = TypedNamedValue<CTCommentsExtensible>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = CommentsExtensibleElement;

/** The Jsonix mapping [org_docx4j_w16cex] exported by the module's JavaScript file. */
export declare const org_docx4j_w16cex: JsonixMapping<RootElement>;
