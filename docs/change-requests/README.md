...
| [CR-006](CR-006-ignorable-prefix-aliases.md) | An `mc:Ignorable` prefix the preferred-prefix table cannot produce, because the namespace is written as the default: Excel's `x` on slicer caches is dropped instead of declared beside the default, as docx4j's CR-024 does | Proposed 2026-09-24 |
