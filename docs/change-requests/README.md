...
| [CR-004](CR-004-round-trip-fidelity.md) | A round-trip fidelity test over parts Office wrote: unmarshal and marshal each through the facade and compare canonically, the kind of test that would have caught the losses docx4j's CR-021 to CR-023 closed (a trial run found a silent, total loss of a drawing part) | Phase A implemented 2026-09-23; phase B proposed |
